...
function getSource(skyAppConfig) {
  ...
  if (skyAppConfig.runtime.command === 'pact') {
    nodeModuleImports.push(`import { SKY_PACT_PROVIDERS } from '@skyux-sdk/pact';`);
    runtimeProviders.push(`SKY_PACT_PROVIDERS`);
  } else {
    runtimeProviders.push('SkyAuthTokenProvider');
  }
